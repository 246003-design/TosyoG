...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <main class="flex-1 p-4 md:p-8 max-w-4xl mx-auto w-full relative">
        <div class="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-300">
            ...
            <!-- ①一括ファイルアップロード用フォーム (multipart/form-data) -->
            ...
            <form action="BookRegisterServlet" method="POST" class="space-y-6">
                <div>
                    ...
                    <div class="flex gap-2">
                        <input type="text" name="isbn" placeholder="ISBNを入力" class="flex-1 p-3 border border-gray-300 rounded focus:ring-2 focus:ring-[#1e3a8a] outline-none font-mono" required />
                        <!-- ※Java側でAPIなどを叩いて自動入力させたい場合は、Ajaxを使うか、別画面遷移にする必要があります -->
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="title" class="w-full p-3 border border-gray-300 rounded focus:ring-2 focus:ring-[#1e3a8a] outline-none" required />
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1">著者</label>
                        <input type="text" name="author" class="w-full p-3 border border-gray-300 rounded focus:ring-2 focus:ring-[#1e3a8a] outline-none" required />
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1">出版社</label>
                        <input type="text" name="publisher" class="w-full p-3 border border-gray-300 rounded focus:ring-2 focus:ring-[#1e3a8a] outline-none" required />
                    </div>
                    <div>
