                ...
                <div class="md:w-2/3 p-6 md:p-10 flex flex-col justify-between">
                    <div>
                       ...
                       <%-- ➔ 変更後：sessionScope.loginUser.id を直接比較に使用します --%>
                        ...
                        <h2 class="text-3xl font-bold text-gray-900 mb-2"><c:out value="${book.bookInfo.title}" />
                        <p class="text-lg text-gray-600 mb-6 border-b pb-4">著者: <c:out value="${book.bookInfo.author}" />
