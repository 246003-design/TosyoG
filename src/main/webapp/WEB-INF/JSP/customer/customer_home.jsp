...
<body class="bg-stone-50 flex flex-col min-h-screen font-sans antialiased text-gray-800">
    ...
    <main class="flex-1 flex flex-col items-center justify-center p-6 gap-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
            <!-- 検索メニューカード -->
            <a href="LibrarySearchServlet" class="group bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl border border-gray-100 hover:border-[#1e5641]/30 transition-all duration-300 hover:-translate-y-1 flex flex-col items-center text-center">
