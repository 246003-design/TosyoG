...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <header class="bg-[#1e3a8a] text-white p-4 shadow-md flex items-center gap-3 sticky top-0 z-20">
        ...
        <h1 class="text-xl font-bold tracking-wider">蔵書管理一覧・更新 (管理者)</h1>
    </header>
    ...
    <main class="flex-1 p-4 md:p-6 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 h-fit sticky top-24">
            <h2 class="text-xl font-bold text-gray-900 mb-6 border-b pb-3">詳細・情報更新</h2>
            ...
            <form action="BookUpdateServlet" method="POST" id="editForm" class="space-y-4">
                ...
                <div class="pt-4 border-t flex justify-between gap-2">
                    <!-- 削除用フォーム -->
                    <button type="submit" formaction="BookDeleteServlet" class="text-red-600 font-bold hover:underline px-2 py-2" onclick="return confirm('本当にこの図書を削除しますか？');">
                        削除
                    </button>
    ...
    <!-- カードをクリックした際にデータを右の入力フォームに同期するJavaScript -->
    <script>
