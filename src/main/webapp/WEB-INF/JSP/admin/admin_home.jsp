...
<body class="bg-slate-50 flex flex-col min-h-screen font-sans antialiased text-gray-800">
    ...
    <main class="flex-1 p-6 md:p-10 max-w-5xl mx-auto w-full flex flex-col justify-center gap-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            <!-- 蔵書管理 -->
            <a href="BookRegisterServlet" class="group bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl border border-gray-100 hover:border-gray-900/30 transition-all duration-300 hover:-translate-y-1 flex items-center gap-6">
