...
<body class="bg-slate-50 flex flex-col min-h-screen font-sans antialiased text-gray-800">
    ...
    <main class="flex-1 p-4 md:p-8 max-w-6xl mx-auto w-full">
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
            ...
            <form action="UserSearchServlet" method="GET" class="p-6 border-b border-gray-100 bg-gray-50/50 flex flex-col sm:flex-row gap-4 justify-between items-center">
                ...
                <table class="w-full text-left border-collapse whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-indigo-50/30 transition-colors group">
                            <td class="p-5 font-mono text-gray-500 text-sm">123456</td>
                            <td class="p-5 font-bold text-gray-900 text-lg">情報 太郎</td>
                            <td class="p-5">
                                <span class="bg-gray-100 text-gray-600 px-3 py-1 rounded-md text-xs font-bold border border-gray-200">司書</span>
                            </td>
                            <td class="p-5 text-gray-600 text-sm">広島情報本部</td>
                            ...
                            <td class="p-5 text-center">
                                <a href="UserDetailServlet?userId=123456" class="inline-flex items-center gap-1.5 px-4 py-2 border-2 border-gray-200 text-gray-700 rounded-lg hover:bg-gray-900 hover:text-white hover:border-gray-900 transition-colors text-sm font-bold shadow-sm">
                        ...
                        <!-- サンプル行 2 -->
                        <tr class="hover:bg-indigo-50/30 transition-colors group">
                            <td class="p-5 font-mono text-gray-500 text-sm">246246</td>
                            <td class="p-5 font-bold text-gray-900 text-lg">広島 花子</td>
                            <td class="p-5">
                                <span class="bg-gray-100 text-gray-600 px-3 py-1 rounded-md text-xs font-bold border border-gray-200">利用者</span>
                            </td>
                            <td class="p-5 text-gray-600 text-sm">総務部</td>
                            <td class="p-5 text-center">
                            ...
                            <td class="p-5 text-center">
                                <a href="UserDetailServlet?userId=246246" class="inline-flex items-center gap-1.5 px-4 py-2 border-2 border-gray-200 text-gray-700 rounded-lg hover:bg-gray-900 hover:text-white hover:border-gray-900 transition-colors text-sm font-bold shadow-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>
                                    詳細 / 編集
                                </a>
                            </td>
